 ...
 * @author be8584
 */
public class ConcreteBlock implements GameRules {
	...
	/**
	 * The black spaces become a different obstacle, concrete blocks. Hedgehogs
	 * can no longer enter these spaces. You can't be caught in them any longer,
