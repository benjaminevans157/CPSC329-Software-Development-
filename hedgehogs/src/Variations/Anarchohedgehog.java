 ...
 * @author be8584
 */
public class Anarchohedgehog implements GameRules {

	private Board board_;//The game board
	private Space[] scoreSpace_;
	/**
	 * The restriction that only pieces of a player's own color may be moved
	 * sideways is removed. Any piece may be moved sideways. The black spaces
	 * naturally become a space that no one wants to be near.
	 */
	private Player player_;

	public Anarchohedgehog() {
